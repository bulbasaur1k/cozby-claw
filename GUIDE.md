...
- **`cozby-claw-gui`** — нативный десктоп-GUI на Slint с fluid-оформлением
  (`cargo run -p gui`). Фаза 1: одна сессия — лента сообщений со стримингом,
  fluid-фон/свечения, индикатор состояния. Модалки прав/вопросов, вкладки,
  вложения и темы — следующие фазы.
